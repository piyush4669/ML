...
conf = SparkConf().setAppName(
    "Gradient-BoostedTreeClassifier").setMaster("local")
...
#          label='Gradient-Boosted Tree Classifier  (AUROC = %0.3f)' % lg_auc)
...
# #print Gradient-Boosted Tree Classifier  AUROC
# print("Gradient-Boosted Tree Classifier  AUROC : ", lg_auc)
