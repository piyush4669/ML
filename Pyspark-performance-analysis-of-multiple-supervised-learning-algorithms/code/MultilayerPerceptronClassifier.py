...
conf = SparkConf().setAppName(
    "MultilayerPerceptronClassifier").setMaster("local")
...
trainer = MultilayerPerceptronClassifier(
    maxIter=100, layers=layers, blockSize=128, seed=1234, featuresCol='features',
    labelCol='swing')
...
#          label='Multilayer Perceptron Classifier  (AUROC = %0.3f)' % lg_auc)
...
# #print Multilayer Perceptron Classifier AUROC
# print("Multilayer Perceptron Classifier AUROC : ", lg_auc)
