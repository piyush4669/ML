...
conf = SparkConf().setAppName(
    "NaiveBayesClassifier").setMaster("local")
...
#          label='Naive-Bayes Classifier  (AUROC = %0.3f)' % lg_auc)
...
# #print Naive-Bayes Classifier AUROC
# print("Naive-Bayes Classifier AUROC : ", lg_auc)
