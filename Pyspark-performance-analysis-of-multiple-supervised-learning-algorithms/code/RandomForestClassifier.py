...
conf = SparkConf().setAppName(
    "RandomForestClassifier").setMaster("local")
...
rf = RandomForestClassifier(featuresCol='features', labelCol='swing')
...
pred = [int(row.prediction) for row in predictions.select("prediction").collect()]
...
#          label='Random Forest Classifier  (AUROC = %0.3f)' % lg_auc)
...
# #print Random Forest Classifier AUROC
# print("Random Forest Classifier AUROC : ", lg_auc)
